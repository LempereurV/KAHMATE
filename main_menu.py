...
class MainMenu:
    def __init__(self, graphic):
        ...
        self.center_center_pos = (
            self.background.get_size()[0] / 2,
            self.background.get_size()[1] / 2 - 30,
        )
        self.center_down_pos = (
            self.background.get_size()[0] / 2,
            self.background.get_size()[1] / 10 * 9,
        )
        self.left_center_pos = (
            self.background.get_size()[0] / 4 + 50,
            self.background.get_size()[1] / 2,
        )
        self.right_center_pos = (
            self.background.get_size()[0] / 4 * 3,
            self.background.get_size()[1] / 2 - 20,
        )
        self.right_center_upper_pos = (
            self.background.get_size()[0] / 4 * 3,
            self.background.get_size()[1] / 4 * 1,
        )
        self.right_center_lower_pos = (
            self.background.get_size()[0] / 4 * 3,
            self.background.get_size()[1] / 4 * 2.5,
        )
        self.center_up_pos = (
            self.background.get_size()[0] / 2,
            self.background.get_size()[1] / 10 * 2,
        )

    def get_font(self, size):  # Returns Press-Start-2P in the desired size
        return pygame.font.Font("assets/font.ttf", size)

    def resize_BG_and_buttons(
        self, event
    ):  # Resize the background and the buttons when the window is resized
    ...
    def play(self):  # Display the gamemode selection menu
        while True:
            ...
            upper_left = (
                self.center_center_pos[0] - 150,
                self.center_center_pos[1] - 100,
            )
            lower_right = (
                self.center_center_pos[0] + 150,
                self.center_center_pos[1] + 100,
            ...
            play_ai_deterministic = Button(
                image=None,
                pos=upper_right,
                text_input="AI DETERMINISTIC",
                font=self.get_font(50),
                base_color="Black",
                hovering_color="Green",
            )
            ...
            play_ai_minmax = Button(
                image=None,
                pos=lower_left,
                text_input="AI MINMAX",
                font=self.get_font(50),
                base_color="Black",
                hovering_color="Green",
            )
            ...
            play_ai_Q_learning = Button(
                image=None,
                pos=lower_right,
                text_input="AI Q-LEARNING",
                font=self.get_font(50),
                base_color="Black",
                hovering_color="Green",
            )
    ...
    def rules_1(self):  # Display the first page of rules
        while True:
            ...
            page = Button(
                image=None,
                pos=(self.center_down_pos[0], self.center_down_pos[1] + 30),
                text_input="1 of 7",
            ...
            left_arrow = pygame.transform.scale(
                left_arrow,
                (left_arrow.get_size()[0] / 10, left_arrow.get_size()[1] / 10),
            )
            arrow_left = Button(
                image=left_arrow,
                pos=(self.center_down_pos[0] - 100, self.center_down_pos[1] - 7),
                text_input="",
                font=self.get_font(50),
                base_color="Black",
                hovering_color="Green",
            ...
            right_arrow = pygame.transform.scale(
                right_arrow,
                (right_arrow.get_size()[0] / 10, right_arrow.get_size()[1] / 10),
            )
            arrow_right = Button(
                image=right_arrow,
                pos=(self.center_down_pos[0] + 100, self.center_down_pos[1] - 7),
    ...
    def rules_2(self):  # Display the second page of rules
        ...
        while True:
            ...
            rect_1 = image_1.get_rect(
                center=(self.left_center_pos[0], self.left_center_pos[1] - 30)
            )
            ...
            image_2 = pygame.transform.scale(
                image_2, (image_2.get_size()[0] / 2, image_2.get_size()[1] / 2)
            )
            ...
            image_3 = pygame.transform.scale(
                image_3, (image_3.get_size()[0] / 2, image_3.get_size()[1] / 2)
            )
    ...
    def main_menu(self):  # Display the main menu
        while True:
            ...
            logo_image = pygame.image.load(
                "assets/logo.png"
            )  # get_font(100).render("KAHMATE", True, "#000000")
            logo_image = pygame.transform.scale(
                logo_image, (logo_image.get_size()[0] / 2, logo_image.get_size()[1] / 2)
            )

            logo_rect = logo_image.get_rect(
                center=(
                    self.background.get_size()[0] / 2,
                    self.background.get_size()[1] / 8 * 1,
                )
            )
            ...
            play_button = Button(
                ...
                pos=(
                    self.background.get_size()[0] / 2,
                    self.background.get_size()[1] / 8 * 3,
                ),
                text_input="PLAY",
            ...
            rules_button = Button(
                ...
                pos=(
                    self.background.get_size()[0] / 2,
                    self.background.get_size()[1] / 8 * 5,
                ),
                text_input="RULES",
                font=self.get_font(75),
                base_color="#d7fcd4",
            ...
            quit_button = Button(
                ...
                pos=(
                    self.background.get_size()[0] / 2,
                    self.background.get_size()[1] / 8 * 7,
                ),
                text_input="QUIT",
                font=self.get_font(75),
                base_color="#d7fcd4",
        ...
        while not kahmate_game.is_game_over():
            ...
            while active_player.get_can_play():
                ...
                if rugbyman_or_ball_or_bool in active_player.get_rugbymen():
                    ...
                    possible_move = kahmate_game.available_move_position(
                        rugbyman_or_ball_or_bool
                    )

                    if rugbyman_or_ball_or_bool in active_player.get_chosen_rugbymen():

                        kahmate_graphics.highlight_move(possible_move)
                        rugbyman_or_ball_or_bool = kahmate_actions.action_rugbyman(
                            rugbyman_or_ball_or_bool, possible_move
                        )
    ...
    def launch_game_minimax(self):
        ...
        kahmate_minimax = minimax.Minimax(
            kahmate_game,
            kahmate_game.get_player_blue(),
            kahmate_actions,
        ...
        while not kahmate_game.is_game_over():
            ...
            if active_player.get_color() == Color.BLUE:
                ...
                for move in moves[:2]:
                    if move != False:
                        kahmate_actions.move_rugbyman(
                            [move[1], move[2]], move[0], move[3]
                        )
                kahmate_graphics.draw_board(kahmate_game)
            ...
            while active_player.get_can_play():
                ...
                if rugbyman_or_ball_or_bool in active_player.get_rugbymen():
                    ...
                    if rugbyman_or_ball_or_bool in active_player.get_chosen_rugbymen():
                        ...
                        kahmate_graphics.highlight_move(possible_move)
                        rugbyman_or_ball_or_bool = (
                            kahmate_minimax_actions.action_rugbyman_AI_defending(
                                rugbyman_or_ball_or_bool, possible_move
                            )
                        )
