...
class ActionBot(Action):
    ...
    def action_rugbyman_bot_defending(self,rugbyman,possible_moves):
        ...
        if pos in possible_moves_without_scope_and_bool:
            ...
            if possible_moves[i][3]:
                ...
                if self.game.is_rugbyman_on_ball()==rugbyman:
                    return self.charging_bot_red_defending(rugbyman,self.game.which_rugbyman_in_pos(pos),possible_moves)
                elif self.game.get_ball().get_pos()==pos:
                    return self.tackling_bot_red_defending(rugbyman,self.game.which_rugbyman_in_pos(pos),possible_moves) 
                else :
                    print("You can only tackle the rugbyman with the ball")  
                    return False
        else :
    ...
    def charging_bot_red_defending(self,rugbyman_attacker,rugbyman_defender,possible_moves):
        """
        This function resolves the charging action between two rugbyman.
    ...
    def tackling_bot_red_defending(self,rugbyman_attacker, rugbyman_defender,possible_moves):
